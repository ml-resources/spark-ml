...
object classification {
	...
	def main(args: Array[String]) {
		...
		val records = sc.textFile("/Users/manpreet.singh/Sandbox/codehub/github/machinelearning/breeze.io/src/main/scala/moviestream/classification/train_noheader.tsv").map(line => line.split("\t"))
