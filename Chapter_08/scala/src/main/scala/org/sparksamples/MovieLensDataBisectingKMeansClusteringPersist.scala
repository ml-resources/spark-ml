...
/**
  * @author Rajdeep Dua
  */
object MovieLensDataBisectingKMeansClusteringPersist {
  ...
  def main(args: Array[String]): Unit = {
    ...
    movie_vectors_reduced.saveAsTextFile(OUTPUT +"bisecting-vectors-" + timeFormatted)
    ...
    clusterOutput.saveAsTextFile(OUTPUT + "bisecting-cluster-membership-" + timeFormatted)
    println("done")
  }
}